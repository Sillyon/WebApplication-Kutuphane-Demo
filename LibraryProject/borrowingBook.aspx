...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="div_success" runat="server" align="center">
        <br />
        <br />
        <asp:Label ID="lblSuccess" runat="server" Visible="False" CssClass="alert alert-success">Ödünç alma işleminiz tamamlanmıştır. Anasayfaya dönmek için <a href="default.aspx"> buraya</a> tıklayınız.</asp:Label>
    </div>
    
    <asp:Label ID="lblBookId" runat="server" CssClass="alert alert-danger"
        Visible="False"><br /><br />***İstenilen sayfaya ulaşılamadı. Ana Sayfaya dönmek için <a 
        href="default.aspx"> buraya</a> tıklayınız.</asp:Label>

    <asp:Label ID="lblBookProperties" runat="server"
        CssClass="alert alert-danger" Visible="False"><br /><br />**Kitap bilgileri yüklemesi esnasında hata oluştu. Ana Sayfaya dönmek için <a 
        href="default.aspx"> buraya</a> tıklayınız.</asp:Label>
